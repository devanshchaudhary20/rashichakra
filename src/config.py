...
SIDE_PADDING = 100
LINE_SPACING = 10
TEXT_PANEL_OPACITY = 110  # 0-255

# Vertical positioning of horoscope text within each zodiac slide:
# the text panel sits in the lower portion so the zodiac art shows above.
HOROSCOPE_TEXT_TOP_FRAC = 0.55  # text starts at 55% down the image
